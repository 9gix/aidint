...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('donation_donation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('donor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
        ...
        db.send_create_signal('donation', ['Donation'])


    def backwards(self, orm):
        # Deleting model 'Donation'
        db.delete_table('donation_donation')
